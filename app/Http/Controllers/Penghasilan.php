...
class Penghasilan extends Controller {
    public function get(Request $request, $id = NULL) {
    	...
    	$select->from('ref_penghasilan AS ph');
    	$count->from('ref_penghasilan AS ph');
    	...
    	if($request->has('attributes') && $request->get('attributes') !== NULL && $request->get('attributes') !== '') {
    		...
    		$select->cols(['id','nama_penghasilan']);
    	}
    	...
    	if($request->has('nama_penghasilan') && $request->get('nama_penghasilan') !== NULL && $request->get('nama_penghasilan') !== '') {
    		$select->where('nama_penghasilan ILIKE :nama_penghasilan',['nama_penghasilan'=>'%'.$request->get('nama_penghasilan').'%']);
    		$count->where('nama_penghasilan ILIKE :nama_penghasilan',['nama_penghasilan'=>'%'.$request->get('nama_penghasilan').'%']);
    	}
